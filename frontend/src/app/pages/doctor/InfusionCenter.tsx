...
// Mock Infusion Data
const mockInfusions = [
  { id: 1, patient: 'John Anderson', regimen: 'AC-T Cycle 3', chair: 'Chair A1', time: '09:00 AM', duration: '3h', status: 'In Progress', progress: 45, verification: 'Verified' },
  { id: 2, patient: 'Maria Garcia', regimen: 'Paclitaxel Cycle 5', chair: 'Chair B2', time: '10:30 AM', duration: '2h', status: 'Scheduled', progress: 0, verification: 'Pending Nurse Check' },
  { id: 3, patient: 'David Miller', regimen: 'FOLFOX Cycle 1', chair: 'Chair A3', time: '11:00 AM', duration: '4h', status: 'Delayed', progress: 0, verification: 'Awaiting Pharmacy', alert: 'Labs pending' },
  { id: 4, patient: 'Lisa Thompson', regimen: 'Keytruda', chair: 'Chair C1', time: '08:00 AM', duration: '1h', status: 'Completed', progress: 100, verification: 'Verified' },
  { id: 5, patient: 'Robert Kim', regimen: 'R-CHOP Cycle 4', chair: 'Chair B1', time: '01:00 PM', duration: '5h', status: 'Scheduled', progress: 0, verification: 'Verified' },
];
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/50">
                {mockInfusions.map((infusion, idx) => (
                  <tr 
                    key={infusion.id} 
