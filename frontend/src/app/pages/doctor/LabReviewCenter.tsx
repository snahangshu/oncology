    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500">Review critical lab results, CMPs, and CBCs across all patients</p>
        </div>
      </div>
        ...
        <Card className="bg-gradient-to-br from-rose-500/10 to-red-500/10 border-rose-500/30 backdrop-blur-xl relative overflow-hidden group">
          ...
          <CardContent className="p-6">
            ...
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-xs text-slate-500 bg-slate-50 px-2 py-1 rounded-full">All clear</span>
            </div>
          </CardContent>
        </Card>
      ...
      <Card className="bg-white/50 border-slate-200 shadow-sm backdrop-blur-xl shadow-2xl rounded-2xl overflow-hidden">
        <CardHeader className="border-b border-slate-200/50 bg-white/20 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              filteredLabs.map((lab, idx) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        <h4 className="text-slate-900 font-bold text-lg">{lab.patient}</h4>
                      ...
                      <div className="flex items-center gap-4 text-sm mt-1">
                        <span className="text-slate-500 font-medium">{lab.type} Report</span>
                  ...
                  <div className="flex flex-row sm:flex-col items-center sm:items-end justify-between sm:justify-center gap-3 w-full sm:w-auto mt-2 sm:mt-0">
                    {lab.status === 'Critical' ? (
                      <Button size="sm" className="bg-rose-500 hover:bg-rose-600 text-slate-900 shadow-lg shadow-rose-500/20 border-0 w-full sm:w-auto">
                      ...
                      <Button size="sm" variant="outline" className="border-slate-200 bg-slate-50 text-slate-700 hover:text-slate-900 w-full sm:w-auto">
                        Acknowledge
                      </Button>
                    )}
                  </div>
