...
export default function CheckInWaitingRoom() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'Scheduled': return <Badge className="bg-slate-500/10 text-slate-400 border-slate-500/30">Scheduled</Badge>;
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400">Track clinic flow and patient wait times</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <Card className="bg-slate-900/50 backdrop-blur-xl border-slate-700/30 border-rose-500/30">
          <CardContent className="p-4 flex items-center gap-4">
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <Select defaultValue={patient.status}>
                          <SelectTrigger className="w-[140px] ml-auto h-8 bg-slate-800/80 border-slate-700/50 text-white text-xs">
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent className="bg-slate-900 border-slate-700/30 text-xs">
